...
def trackMultipleObjects():
    ...
    while True:
        ...
        cv2.line(resultImage,(0,mark1),(1280,mark1),(0,0,255),1)
        cv2.line(resultImage,(0,mark2),(1280,mark2),(0,0,255),1)
        ...
        for carID in carTracker.keys():
            ...
            if carID not in startTracker and mark2 > ty+th > mark1 and ty < mark1:
                ...
                if speed > speedLimit:
                    print('CAR-ID : {} : {} km/h - OVERSPEED'.format(carID, speed))
                    saveCar(speed,image[ty:ty+th, tx:tx+tw])
                else:
                    print('CAR-ID : {} : {} km/h'.format(carID, speed))
